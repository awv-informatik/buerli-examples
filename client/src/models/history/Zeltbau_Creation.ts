...
const createVW_2Erker = async (api: ApiHistory) => {
  ...
  await api.boolean(wand_Part, BooleanOperationType.SUBTRACTION, [wand_Slice, tuere, fensterL0, fensterL1, fensterL2, fensterR0, fensterR1, fensterR2])
  return wand_Part
}
